...
namespace Clay
{
   EditorLayer::EditorLayer() : Layer("Sandbox2D")
   {
      ...
      Ref<TriangleMesh> modelMesh = std::make_shared<TriangleMesh>(glm::vec4(0.3,0.5,0.7,1.0), nullptr);
...
//      Ref<PointCloud> secondPCL = std::make_shared<PointCloud>(glm::vec4(0.4,0.3,0.4,1), nullptr);
